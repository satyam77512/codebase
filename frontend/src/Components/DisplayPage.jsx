...
const DisplayPage = () => {
  ...
  const handleResumeUpload = (e) => {
    ...
    axios
      .put(`${BaseUrl()}/user/details/changeResume`,{imageFile,RollNumber:data.RollNumber}, {
        headers: headers,
      })
      .then((response)=>{
        dispatch(updateUserdata("Resume",response.data))
      })
    setIsModalOpen(false);
  };
  ...
  return (
    ...
    <div className="container">
        ...
        <div className="content">
            ...
            {data.Resume ? (
                <a href={`${BaseUrl()}/${data.Resume}`} target="_blank" rel="noopener noreferrer">
                View Resume
                </a>
            ) : (
                'N/A'
